...
void delAuthor(bookPtr &root)
{
    ...
    bookPtr p = locateNode(root, author);
...
void searchAuthor(bookPtr temp)
{
    string author;
...
int main()
{
    ...
    do
    {
        ...
        cout << "(4) Delete a book based on Author\n";
        cout << "(5) Search for a book by ISBN.\n";
        cout << "(6) Search for a book by Title.\n";
    	cout << "(7) Search for a book by Author.\n";
        cout << "(8) List all books.\n";
        cout << "(9) List all books by an author.\n";
        cout << "(10) Quit.\n\n";
